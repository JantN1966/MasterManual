...
### 1.1. Descriptive statistics of performance data, genomic data and pedigree
...
#### 1.1.1. Means and standard deviations (option D)
...
#### 1.1.1. Class effect levels grouped by available information (option H)
...
#### 1.1.1. Valid data records for each combination of trait and class effect level (option L)
...
### 1.1. Diagnostics of use of base populations
