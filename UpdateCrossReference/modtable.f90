module modtable
    ...
    use modhashfun, only: roundinguppower2, seed_hash, hash
    implicit none
    private
    public::tablechar_t
    public::tableint32_t
    public::tablereal32_t
    ...
    type, extends(tableabstrat_t) :: tablechar_t !(k)
     private
     !integer, len :: k
    ...
    interface tablechar_t
     module procedure constructor_tablechar_t
    end interface
   
    type, extends(tableabstrat_t) :: tableint32_t !(k)
     private
     !integer, len :: k
     !character(len=k),allocatable::stored(:)
    ...
    interface tableint32_t
     module procedure constructor_tableint32_t
    end interface
   
    type, extends(tableabstrat_t) :: tablereal32_t !(k)
     private
     !integer, len :: k
     !character(len=k),allocatable::stored(:)
    ...
    interface tablereal32_t
     module procedure constructor_tablereal32_t
    end interface
   
    type, extends(tableabstrat_t) :: table_arrint32_t
     private
     integer(int32), allocatable ::stored(:, :)
    contains
     private
    ...
    type, extends(tableabstrat_t) :: table_arrreal32_t
     private
     real(real32), allocatable ::stored(:, :)
    contains
     private
   ...
   contains
    ...
    recursive subroutine add_tablechar_t(this, c, index, lnew) !, col)
     class(tablechar_t), intent(inout) :: this
    ...
    contains
     ...
     subroutine increase_size()
      type(tablechar_t) :: thistmp
   
      thistmp = tablechar_t(len(this%stored), nel=int(this%nel*1.5, int32))
    ...
    pure subroutine destroy_tablechar_t_scal(this)
     type(tablechar_t), intent(inout) :: this
    ...
    pure function get_tablechar_t(this, index) result(c)
     class(tablechar_t), intent(in) :: this
    ...
    recursive subroutine add_tableint32_t(this, c, index, lnew) !, col)
     class(tableint32_t), intent(inout) :: this
    ...
    contains
     ...
     subroutine increase_size()
      type(tableint32_t) :: thistmp
   
      thistmp = tableint32_t(nel=int(this%nel*1.5, int32))
    ...
    pure subroutine destroy_tableint32_t_scal(this)
     type(tableint32_t), intent(inout) :: this
    ...
    pure function get_tableint32_t(this, index) result(c)
     class(tableint32_t), intent(in) :: this
     integer(int32), intent(in) :: index
     integer(int32) :: c
    ...
    recursive subroutine add_tablereal32_t(this, c, index, lnew) !, col)
     class(tablereal32_t), intent(inout) :: this
    ...
    contains
     ...
     subroutine increase_size()
      type(tablereal32_t) :: thistmp
   
      thistmp = tablereal32_t(nel=int(this%nel*1.5, int32))
    ...
    pure subroutine destroy_tablereal32_t_scal(this)
     type(tablereal32_t), intent(inout) :: this
    ...
    pure function get_tablereal32_t(this, index) result(c)
     class(tablereal32_t), intent(in) :: this
     integer(int32), intent(in) :: index
     real(real32) :: c
