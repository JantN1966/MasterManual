## 1. Decoding any file with coded class effect labels
...
#### 1.1.1. Decoding individual coded class effect labels
...
#### 1.1.1. Decoding a file that contains coded class effect labels
