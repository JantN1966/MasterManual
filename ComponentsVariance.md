## 1. Components of variance and covariance among traits
...
#### 1.1.1  Input file in lower-triangular-matrix format 
...
!#IF(HPB)!#ELSE
#### 1.1.1 Input file in sparse-matrix format for the MiX99 solver
...
### 1.1 Parameter files for general covariates
...
### 1.1. Parameters for SNP covariate files 
...
### 1.1. Parameters in case of heterogeneous residual variances 
