...
The instruction file contains all information that !#IF(HPB)HPBLUP!#ELSEMiXBLUP!#ENDIF needs for the analysis. This chapter gives an overview of the instruction file. The various parts of the instruction file are discussed in detail in the next chapters.
...
4. Components of variance and covariance among traits (Chapter [1.](#Comp01))\
5. Statistical models (Chapter [1.](#Stat01))\
6. Control of analysis and output (Chapter [1.](#Cont01))
...
Statistical models are specified by trait. Each trait starts on a new line. The only sections in this part of the instruction file are MODEL, LINKEDEFFECTS and COMBINE. The syntax of the various statistical models supported by !#IF(HPB)HPBLUP!#ELSEMiXBLUP!#ENDIF are presented in Chapter [1.](#Stat01)
