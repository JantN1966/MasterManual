...
#### 1.1.1 Recommended file formats {#Gene04}
...
##### 1.1.1.1. Pedigree inbreeding coefficient file {#Gene06}
...
#### 1.1.1. Pedigree inbreeding coefficients {#Gene07}

##### 1.1.1.1. General {#Gene08}
...
##### 1.1.1.1. Syntax of calculating inbreeding coefficients {#Gene09}
...
### 1.1 Preparing genomic data {#Gene21}

#### 1.1.1 General {#Gene22}
...
#### 1.1.1 Recommended file formats {#Gene23}

##### 1.1.1.1 Genomic data {#Gene24}
...
##### 1.1.1.1 Allele frequencies {#Gene25}
...
### 1.1. Genetic similarity from pedigree only {#Gene26}

#### 1.1.1. General {#Gene27}
...
#### 1.1.1. Syntax of using pedigree BLUP {#Gene28}
...
#### 1.1.1. Genetic similarity from genomic data with unknown pedigree {#Gene30}
...
##### 1.1.1.1. Syntax using a new APY inverse of genomic relationship matrix using a predefined list of core animals {#Gene42}
...
##### 1.1.1.1. Syntax using a new APY inverse of genomic relationship matrix using a number of random core animals determined by PCA {#Gene43}
...
##### 1.1.1.1. Syntax using an existing APY inverse of genomic relationship matrix {#Gene44}
...
!#IF(M99)!#ELSE
#### 1.1.1. Modelling a genetic difference between genotyped and non-genotyped individuals!#ENDIF!#IF(MiX) with the hpblup solver!#ENDIF {#Gene50}
...
### 1.1. Non-additive genetic similarity {#Gene63}
...
#### 1.1.1. Expected heterosis and recombination in crossbreds {#Gene65}
...
##### 1.1.1.1. Output files {#Gene69}

| Output file | Description |
| --- | --- |
|  |  |

#### 1.1.1. Genomic epistasis effects (to complete) {#Gene70}

##### 1.1.1.1. General {#Gene71}
