...
##### 4.2.2.2.  Syntax using a newly created covariate table for the MiX99 solver
>DATAFILE \<filename\> \
>...\
>\<field k\> I !CVRIND \
>...\
...
The G(…) function and the SNP(…) function in the MODEL section are used to link genetic similarity to data records (Chapter 7).
...
#### 5.5.3.  Using APY to invert genomic relationship matrix
...
##### 5.5.3.3.  Syntax using a new APY inverse of genomic relationship matrix using a predefined number of random c
...
##### 5.5.3.4.  Syntax using a new APY inverse of genomic relationship matrix using a predefined list of core anima
...
##### 5.5.3.5.  Syntax using a new APY inverse of genomic relationship matrix using a number of random core animals
...
##### 5.5.3.6.  Syntax using an existing APY inverse of genomic relationship matrix
...
##### 5.5.3.7.  Associated output files
...
##### 9.2.1.3.  Sorting data and pedigree file on block variable
...
##### 9.2.1.4.  Strategies for block definition
...
##### 9.2.1.6.  Genetic similarity between individuals
...
### 9.3.  Command-line interface for calculating reliabilities
...
### 10.2.  Descriptive statistics of performance data, genomic data and pedigree
...
#### 10.2.4.  Means and standard deviations (option D)
...
#### 10.2.5.  Class effect levels grouped by available information (option H)
...
#### 10.2.6.  Valid data records for each combination of trait and class effect level (option L)
...
#### 10.2.7.  Associated output files
|Output file | Description|
| --- | --- |
|Statistics.log | Output file with tables for the options specified|

### 10.3.  Diagnostics of use of base populations
...
#### 10.3.2.  Equivalent number of base animals genotyped
...
#### 10.3.3.  Auto-similarity to another base population
...
#### 10.3.4.  Number of generations between pedigree and genomic base populations
...
#### 10.3.6.  Associated output files
|Output file | Description|
| --- | --- |
...
## 11.  Validation studies with MiXBLUP
...
### 12.1.  Starting a MiXBLUP evaluation
...
### 12.2.  Choosing a breeding value evaluation or a reliability calculation
...
### 12.3.  A breeding value analysis with previous solutions as starting values
...
### 12.4.  Monitoring and checking the process
...
### 12.5.  Interrupting a process of the kernel
...
## 13.  Decoding any file with coded class effect labels
...
#### 13.2.3.  Decoding individual coded class effect labels
...
#### 13.2.4.  Decoding a file that contains coded class effect labels
