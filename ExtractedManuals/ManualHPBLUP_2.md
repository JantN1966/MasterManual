...
##### 4.2.2.1.  Syntax using an existing covariate table for the hpblup solver
...
##### 4.2.2.2.  Syntax using newly created covariate tables for the hpblup solver
...
##### 4.3.3.2.  Syntax of fitting a general covariate file in the model for the hpblup solver
...
#### 5.5.7.  Modelling a genetic difference between genotyped and non-genotyped individuals
...
#### 5.5.8.  Obtaining solutions for genetic marker effects
...
#### 7.4.2.    Syntax of the social interaction model for the hpblup solver
>DATAFILE\
>Animal I\
>\<...\>\
>\mate1 I \
...
#### 7.5.2.  Syntax of a simple non-genetic random regression model for the hpblup solver
>REGFILE \
...
#### 7.5.3.  Syntax of a simple genetic random regression model for the hpblup solver
>REGFILE \
>\<field ID\> \<field type I or A\> \
>REG02 \<file name REG02\> !REGTYPE \<R or H\> \
REGPARFILE \
...
#### 7.5.4.  Syntax of a polynomial regression model using a covariate table for the hpblup solver
>CVRTABLE !nCVRTABLES 2 \
...
##### 8.1.2.1.  Syntax when using hpblup solver
>SOLVING\
>[!hpblup]\
...
##### 8.2.2.1.  Syntax when using hpblup solver
>SOLVING\
...
### 14.1.  Starting a HPBLUP evaluation
