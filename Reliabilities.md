...
##### 1.1.1.1. Sorting data and pedigree file on block variable
...
##### 1.1.1.1. Strategies for block definition
...
##### 1.1.1.1. Genetic similarity between individuals
...
!#IF(MiX)
### 1.1. Approximate genomic reliabilities
...
### 1.1. Command-line interface for calculating reliabilities
